...
int java_method_init(JNIEnv *env) {
    jni_helper_class = (*env)->FindClass(env, "com/shiqi/quickjs/JNIHelper");
...
#define GET_STATIC_METHOD(RESULT, NAME, SIGN)                                             \
    ...
    GET_STATIC_METHOD(js_value_to_java_value_method, "jsValueToJavaValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;J)Ljava/lang/Object;");
    GET_STATIC_METHOD(java_boolean_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;Z)J");
    GET_STATIC_METHOD(java_char_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;C)J");
    GET_STATIC_METHOD(java_byte_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;B)J");
    GET_STATIC_METHOD(java_short_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;S)J");
    GET_STATIC_METHOD(java_int_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;I)J");
    GET_STATIC_METHOD(java_long_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;J)J");
    GET_STATIC_METHOD(java_float_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;F)J");
    GET_STATIC_METHOD(java_double_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;D)J");
    GET_STATIC_METHOD(java_object_to_js_value_method, "javaValueToJSValue", "(Lcom/shiqi/quickjs/JSContext;Ljava/lang/reflect/Type;Ljava/lang/Object;)J");
